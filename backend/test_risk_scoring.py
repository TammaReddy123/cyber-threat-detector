...
predicted_label = 'safe'  # What the model predicted
label_probs = {'safe': 0.929, 'malicious': 0.071}  # From our test
...
safe_result = compute_risk_score(safe_url, 'safe', {'safe': 0.95, 'malicious': 0.05})
